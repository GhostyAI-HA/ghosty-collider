...
> **Output:** *"The Pilgrimage Loop"* — a game designed to be left, where an AI companion tends your world while you're away. You return to find what grew in your absence.
>
> That idea didn't come from brainstorming. It came from stripping three unrelated observations down to their deep structure and colliding them. [Full walkthrough →](./examples/game_design_collision.md)

---

## Who This Is For

- **Strategists & PMs** who need non-obvious ideas, not more brainstorming
...
📖 [Full Protocol](./GHOSTY_COLLIDER.md) · [Example: Game Design Collision](./examples/game_design_collision.md)
...
Takes existing ideas, destroys their typicality bias, and forces them into structurally novel territory.
...
**Theoretical basis:** Typicality Bias (Doshi & Hauser 2024), Constraint-based Creativity (Stokes 2005), Structural Analogy (Gick & Holyoak 1983)
...
- **Refinements** — Improve Ghost Extraction techniques, Collision Scoring criteria, or Timing Grid axes
- **Translations** — Help make these protocols accessible in more languages
